...
// Credentials ----------------------------------------
#define SSID         "Black Bok";                      // Your WiFi credentials here
#define PW          "0191435782112345";

// Timezone -------------------------------------------
//#define TZName       "CET-1CEST,M3.5.0,M10.5.0/3"   // Berlin (examples see at the bottom)
#define TZName     "GMT+6"     // dhaka
//#define TZName     "GMT+6"                     // dhaka bangladesh

// User defined text ----------------------------------
//#define UDTXT        "    Добрый день!  ΕΠΙΧΡΥΣΟ  "

// other defines --------------------------------------
#define BRIGHTNESS   2     // values can be 0...15
#define anzMAX       4     // number of cascaded MAX7219 6 silo
...
String   _SSID = "Black Bok";
String   _PW   = "0191435782112345";
...
public:
    RTIME();
    ~RTIME();
    boolean begin(String TimeZone="GMT+6"); // CET-1CEST,M3.5.0,M10.5.0/3
    const char* gettime();
...
//objects
RTIME rtc; //etai main culprit RTIME class ta upore lekha ase it is not a default class
WiFiMulti wifiMulti;
Ticker tckr;
